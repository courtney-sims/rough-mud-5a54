...
```
npm create cloudflare@latest -- --template=cloudflare/templates/rough-mud-5a54
```

A live public deployment of this template is available at [https://rough-mud-5a54.templates.workers.dev](https://rough-mud-5a54.templates.workers.dev)
